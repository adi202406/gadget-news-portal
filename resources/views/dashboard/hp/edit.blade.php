            ...
            <div class="col">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Form Edit Phone</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="post" action="/dashboard/hp/{{ $hp->slug}}" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('slug') is-invalid @enderror"
                                    id="slug" placeholder="Slug" name="slug" required value="{{ old('slug', $hp->slug) }}">
                                @error('slug')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="oldImage" value="{{ $hp->image }}">
                                @if($hp->image)
                                    <img src="{{ asset('storage/' . $hp->image) }}" class="img-preview img-fluid mb-2 col-sm-5 d-block">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('tanggalRilis') is-invalid @enderror"
                                    ...
                                    value="{{ old('tanggalRilis', $hp->tanggalRilis) }}">
                                @error('tanggalRilis')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('jaringan') is-invalid @enderror"
                                    ...
                                    value="{{ old('jaringan', $hp->jaringan) }}">
                                @error('jaringan')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('ukuranLayar') is-invalid @enderror"
                                    ...
                                    value="{{ old('ukuranLayar', $hp->ukuranLayar) }}">
                                @error('ukuranLayar')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('refreshRate') is-invalid @enderror"
                                    ...
                                    value="{{ old('refreshRate', $hp->refreshRate) }}">
                                @error('refreshRate')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('resolusi') is-invalid @enderror"
                                    ...
                                    value="{{ old('resolusi', $hp->resolusi) }}">
                                @error('resolusi')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('proteksiLayar') is-invalid @enderror"
                                    ...
                                    value="{{ old('proteksiLayar', $hp->proteksiLayar) }}">
                                @error('proteksiLayar')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                value="{{ old('kameraBelakang', $hp->kameraBelakang) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('kameraMpBelakang') is-invalid @enderror"
                                    ...
                                    value="{{ old('kameraMpBelakang', $hp->kameraMpBelakang) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('kameraDepan') is-invalid @enderror"
                                    ...
                                    value="{{ old('kameraDepan', $hp->kameraDepan) }}">
                                @error('kameraDepan')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control  @error('kameraMpDepan') is-invalid @enderror"
                                        ...
                                        value="{{ old('kameraMpDepan', $hp->kameraMpDepan) }}">
                                    @error('kameraMpDepan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <input type="text" class="form-control  @error('bluetooth') is-invalid @enderror"
                                    ...
                                    value="{{ old('bluetooth', $hp->bluetooth) }}">
                                @error('bluetooth')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('infrared') is-invalid @enderror"
                                    ...
                                    value="{{ old('infrared', $hp->infrared) }}">
                                @error('infrared')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('jenisBaterai') is-invalid @enderror"
                                    ...
                                    value="{{ old('jenisBaterai', $hp->jenisBaterai) }}">
                                @error('jenisBaterai', $hp->jenisBaterai)
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('kapasitasBaterai') is-invalid @enderror"
                                    ...
                                    value="{{ old('kapasitasBaterai', $hp->kapasitasBaterai) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('fiturCas') is-invalid @enderror"
                                    ...
                                    value="{{ old('fiturCas', $hp->fiturCas) }}">
                                @error('fiturCas')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
