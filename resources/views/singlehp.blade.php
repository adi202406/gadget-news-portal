        ...
        <div class="row justify-content-center mb-3">
            <div class="col-md-8">
                ...
                <article class="my-3 fs-5">
                    <h3 class="text-light text-center rounded" style="background-color: rgba(4, 217, 217, 0.315)">SPESIFIKASI</h2>
                        <table class="table ">
                            <tbody>
                                <tr>
                                    <td>
                ...
                <a href="/blog"> <i class="fa-solid fa-angles-left mb-3"></i>BACK</a>
            </div>
        </div>
    </div>
